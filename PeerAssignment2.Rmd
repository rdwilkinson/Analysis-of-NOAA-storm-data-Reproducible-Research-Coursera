...
```{r}
newStormData$PROPDMGEXP[newStormData$PROPDMGEXP == ""] <- "empty"
...
```{r}
newStormData$numericDamage3 <- str_detect(newStormData$PROPDMGEXP, "[:punct:]")
table(newStormData$numericDamage3)
newStormData$numericDamage4 <- str_detect(newStormData$CROPDMGEXP, "[:punct:]")
